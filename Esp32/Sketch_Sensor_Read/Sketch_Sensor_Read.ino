...
/**
  ...
  Important: You can only use ADC1 pins (32, 33, 34, 35, 36, 39) //unsure when used with C6 version of ESP32
...
/**
   WiFi settings
*/
const char* WIFI_SSID     = "WG";
const char* WIFI_PASSWORD = "2d9du0E8b3d%1d38KaRP";

/**
   Server component settings
*/
const char*    SERVER_HOST = "http://plantwatering.wi-wo.ch";
const char*    SERVER_URI  = "/";
const uint16_t SERVER_PORT = 443;
const char*    SERVER_PSK  = "sdkweWTGgserFFLove";
